...
The final section must be exactly one annex:
...
No non-whitespace content may appear after the annex end marker.
...
2. requires exactly one integrated 04 inquisition result before the annex;
3. requires the annex to be the final section;
